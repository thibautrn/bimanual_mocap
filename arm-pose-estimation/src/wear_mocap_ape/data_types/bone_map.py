...
class BoneMap:
    ...
    @property
    def right_lower_arm_length(self):
        return np.linalg.norm(self.right_lower_arm_vec)

    @property
    def right_upper_arm_origin_rh(self):
        """default right upper arm origin relative to hip (rh)"""
        return self.__bonemap[11].default_pos - self.__bonemap[1].default_pos  # Hips
    ...
    @property
    def right_upper_arm_length(self):
        return np.linalg.norm(self.right_upper_arm_vec)
