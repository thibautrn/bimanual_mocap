...
class WatchPhoneUarm(Estimator):
    ...
    def calibrate_orientation_quats(self,
        ...
        # estimate north quat to align Z-axis of global and android coord system (right arm)
        quat_north = ts.calib_watch_right_to_north_quat(sw_fwd)
        # the arm orientations if the calib position with right arm forward is perfect
