...
def generate_launch_description():
    ...
    package_name_gazebo = 'bimanualrobot_gazebo'
    package_name_description = 'bimanualrobot_description'
    package_name_moveit = 'bimanualrobot_moveit_config'

    default_robot_name = 'bimanualrobot'
    ...
    pkg_share_gazebo = get_package_share_directory('bimanualrobot_gazebo')
    drum_model_path = os.path.join(pkg_share_gazebo, 'models', 'drum_cylinder', 'model.sdf')
    ...
    # spawn_drum_node = Node(
    #     package='bimanualrobot_gazebo',
    #     executable='spawn_drum.py',
    #     output='screen'
    # )

    # yield LogInfo(msg=f"Gazebo models path: {gazebo_models_path}")
    ...
    # ld.add_action(spawn_drum_node)

    # Add the drum spawn action to the launch description
    ld.add_action(spawn_drum_cmd)
    ld.add_action(LogInfo(msg=f"Spawning drum cylinder, from model path: {drum_model_path}"))
