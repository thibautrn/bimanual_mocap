...
# ======================= USER SETTINGS =======================
INPUT_DIR   = "/home/asurite.ad.asu.edu/troisin/Documents/robot/bimanual_mocap/bimanual_ws/src/bimanualrobot_ros2/bimanualrobot_system_tests/scripts/logs/joints"       # folder with *.txt (timestamp x y z)
OUTPUT_DIR  = "/home/asurite.ad.asu.edu/troisin/Documents/robot/bimanual_mocap/bimanual_ws/src/bimanualrobot_ros2/bimanualrobot_system_tests/scripts/logs/joints"         # we'll save baseline + weights here
